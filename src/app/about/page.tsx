            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
              ...
              <div className="flex-1 space-y-5 text-center md:text-left">
                ...
                <p className="text-base font-bold text-gray-700 leading-relaxed max-w-2xl">
                  "20년 이상의 현업 금융 지식과 퇴직연금 포트폴리오 관리 성과를 바탕으로, 자산배분 시장을 리딩하며 고객 맞춤형 최적 ETF 포트폴리오를 제공합니다."
                </p>

                <p className="text-base text-gray-500 leading-relaxed">
                  하나증권 PB 및 대형 자산운용사 펀드매니저 출신으로, 퇴직연금, 펀드 분야에서 탁월한 자산관리 수익률(IRP 전업권 1위)을 달성한 금융 전문가입니다.
                </p>
