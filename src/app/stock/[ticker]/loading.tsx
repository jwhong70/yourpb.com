        ...
        <div className="pt-8 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8 mt-10">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div className="h-6 w-28 bg-gray-100 rounded-none" />
              </div>
          ...
          <div className="grid grid-cols-1 min-[480px]:grid-cols-2 gap-8">
            <div className="h-72 bg-box-bg border border-gray-200 flex items-center justify-center">
              <span className="text-sm font-semibold text-gray-400">주가 캔들 차트를 불러오는 중...</span>
            </div>
            <div className="h-72 bg-box-bg border border-gray-200 flex items-center justify-center">
              <span className="text-sm font-semibold text-gray-400">수익률 지표를 불러오는 중...</span>
            </div>
          </div>
